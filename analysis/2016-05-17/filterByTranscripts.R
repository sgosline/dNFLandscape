...
fname=gsub('.tsv','_ilteredForExpr.tsv',basename(synGet('syn6047991')@filePath))
write.table(expr.gene.muts,file=fname,sep='\t',quote=F)

synStore(File(fname,parentId='syn5605256'),executed=list(list(url='')),used=list(list(entity='syn6047991')))
