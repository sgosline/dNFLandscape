...
set.seed(42)
<<<<<<< HEAD
cols <- c("blue", "red", "black", "orange", "green", "pink", "yellow")
=======
cols <- c("blue", "red", "black", "orange", "green", "black", "brown")
>>>>>>> 6b2105db7ea30b3652e7478660458c2977a8e266
...
<<<<<<< HEAD
waterfall(soms %>% filter(Hugo_Symbol %in% cosmic$Gene.Symbol), fileType = "MAF", mainRecurCutoff = 0.0, mainDropMut = TRUE, mainPalette = cols)
=======
